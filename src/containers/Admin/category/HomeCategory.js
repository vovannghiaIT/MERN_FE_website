...
const HomeCategory = () => {
  ...
  const submitStatus = (items) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        console.log(items);
        await apiUpdateCategories({ ...items, status: 0 });
        fetchData();
      }
    });
  };
  ...
  const total = categories.filter((item) => item.status === 1);
            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
              <div className="flex flex-col">
                ...
                <div className="my-2 py-2 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                  <div className="align-middle inline-block w-full overflow-x-auto shadow  sm:rounded-lg border-b border-gray-200">
